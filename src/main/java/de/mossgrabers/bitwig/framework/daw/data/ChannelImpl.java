...
public class ChannelImpl extends AbstractDeviceChainImpl<Channel> implements IChannel
{
    ...
    public ChannelImpl (final IHost host, final IValueChanger valueChanger, final Channel channel, final int index, final int numSends)
    {
        ...
        DeviceBank deviceCursor = this.deviceChain.createDeviceBank(1);
        this.remoteControls = deviceCursor.getDevice(0).createCursorRemoteControlsPage(8);
        ...
        this.remoteControlParameter = new ParameterImpl (valueChanger, this.remoteControls.getParameter(0), 0);
    ...
    /** {@inheritDoc} */
    @Override
    public String getRemoteControlStr (final int index)
    {
        return this.remoteControlParameter.getDisplayedValue ();
    }


    /** {@inheritDoc} */
    @Override
    public String getRemoteControlStr (final int index, final int limit)
    {
        return this.remoteControlParameter.getDisplayedValue (limit);
    }
    ...
    {
		return this.remoteControlParameter.getValue ();
    }

    /** {@inheritDoc} */
    @Override
    public void changeRemoteControl (final int index, final int control)
    {
        this.remoteControlParameter.changeValue (control);
    }
    
    
    /** {@inheritDoc} */
    @Override
    public void setRemoteControl (final int index, final int value)
    {
        this.remoteControlParameter.setValue (value);
    }


	/** {@inheritDoc} */
    @Override
    public void resetRemoteControl (final int index)
    {
        this.remoteControlParameter.resetValue ();
    }


    /** {@inheritDoc} */
    @Override
    public void touchRemoteControl (final int index, final boolean isBeingTouched)
    {
        this.remoteControlParameter.touchValue (isBeingTouched);
    }


    /** {@inheritDoc} */
    @Override
    public void setRemoteControlIndication (final int index, final boolean indicate)
    {
        this.remoteControlParameter.setIndication (indicate);
    }


    /** {@inheritDoc} */
    @Override
    public int getModulatedRemoteControl (final int index)
    {
        return this.remoteControlParameter.getModulatedValue ();
    }
