...
public interface IChannel extends IItem
{
	...
	/**
     * Get the RemoteControl as a formatted text
     *
     * @return The RemoteControl text
     */
    String getRemoteControlStr (int index);
     ...
     * @return The RemoteControl text
     */
    String getRemoteControlStr (int index, int limit);
     ...
     */
    int getRemoteControl (int index);


	/**
     * Change the RemoteControl.
     *
     * @param control The control value
     */
    void changeRemoteControl (int index, int control);
     ...
     * @param value The new value
     */
    void setRemoteControl (int index, int value);


    /**
     * Reset the RemoteControl to its default value.
     */
    void resetRemoteControl (int index);


    /**
     * Signal that the RemoteControl fader/knob is touched for automation recording.
     *
     * @param isBeingTouched True if touched
     */
    void touchRemoteControl (int index, boolean isBeingTouched);


    /**
     * Signal that the RemoteControl is edited.
     *
     * @param indicate True if edited
     */
    void setRemoteControlIndication (int index, boolean indicate);


    /**
     * Get the modulated RemoteControl.
     *
     * @return The modulated RemoteControl
     */
    int getModulatedRemoteControl (int index);
