...
public class APCColors
{
    ...
    public static void addColors (final ColorManager colorManager, final boolean isMkII)
    {
        ...
        if (isMkII)
        {
            ...
            colorManager.registerColor (DAWColors.DAW_COLOR_DARK_BLUE, APC_MKII_COLOR_BLUE);
            colorManager.registerColor (DAWColors.DAW_COLOR_PURPLE_BLUE, APC_MKII_COLOR_BLUE_ORCHID_ALT);
            colorManager.registerColor (DAWColors.DAW_COLOR_PURPLE, APC_MKII_COLOR_ORCHID);
            colorManager.registerColor (DAWColors.DAW_COLOR_PINK, APC_MKII_COLOR_MAGENTA);
            colorManager.registerColor (DAWColors.DAW_COLOR_RED, APC_MKII_COLOR_RED_LO);
            colorManager.registerColor (DAWColors.DAW_COLOR_ORANGE, APC_MKII_COLOR_AMBER);
            colorManager.registerColor (DAWColors.DAW_COLOR_LIGHT_ORANGE, APC_MKII_COLOR_YELLOW);
            colorManager.registerColor (DAWColors.DAW_COLOR_MOSS_GREEN, APC_MKII_COLOR_LIME_LO);
            colorManager.registerColor (DAWColors.DAW_COLOR_GREEN, APC_MKII_COLOR_SPRING_LO);
            colorManager.registerColor (DAWColors.DAW_COLOR_COLD_GREEN, APC_MKII_COLOR_TURQUOISE_HI);
            colorManager.registerColor (DAWColors.DAW_COLOR_BLUE, APC_MKII_COLOR_OCEAN);
