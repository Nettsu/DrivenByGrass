...
public class APCColors
{
    ...
    public static void addColors (final ColorManager colorManager, final boolean isMkII)
    {
        ...
        if (isMkII)
        {
            ...
            colorManager.registerColor (BitwigColors.BITWIG_COLOR_DARK_BLUE, APC_MKII_COLOR_BLUE_LO);
            ...
            colorManager.registerColor (BitwigColors.BITWIG_COLOR_PINK, APC_MKII_COLOR_PINK_LO);
            ...
            colorManager.registerColor (BitwigColors.BITWIG_COLOR_GREEN, APC_MKII_COLOR_SPRING_LO);
            colorManager.registerColor (BitwigColors.BITWIG_COLOR_COLD_GREEN, APC_MKII_COLOR_TURQUOISE_HI);
            colorManager.registerColor (BitwigColors.BITWIG_COLOR_BLUE, APC_MKII_COLOR_OCEAN);
